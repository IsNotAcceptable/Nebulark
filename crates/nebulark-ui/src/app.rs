...
fn config_path() -> String {
    ...
    home.join(".config").join("nebulark").join("config.toml")
        ...
        egui::CentralPanel::default()
            ...
            .show(ctx, |ui| {
                ...
                ui.vertical_centered(|ui| {
                    ui.label(RichText::new("NEBULARK")
                        .font(FontId::proportional(28.0))
                        .color(Color32::from_rgb(100, 200, 255))
                        .strong());
                    ui.label(RichText::new("AmneziaWG 2.0 client")
                ...
                ui.vertical_centered(|ui| {
                    let (dot_color, state_text) = match self.state {
                        ...
                        ConnState::Disconnected => (Color32::from_rgb(100, 100, 120), "Disconnected"),
                    };
                    ui.horizontal(|ui| {
                ...
                ui.label(RichText::new("Profiles")
                ...
                egui::ScrollArea::vertical()
                    ...
                    .show(ui, |ui| {
                        if self.profiles.is_empty() {
                            ui.label(RichText::new("No profiles. Import a .conf file.")
                                .color(Color32::from_rgb(80, 80, 100))
                                .italics());
                        }
                        for (i, name) in self.profiles.iter().enumerate() {
                            ...
                            let resp = egui::Frame::none()
                                ...
                                .stroke(Stroke::new(
                                    1.0,
                                    if selected { Color32::from_rgb(100, 180, 255) }
                ...
                if !self.status_msg.is_empty() {
                    ui.add_space(8.0);
                    ui.vertical_centered(|ui| {
                        ui.label(RichText::new(&self.status_msg)
                            .font(FontId::proportional(11.0))
                ...
                ui.horizontal(|ui| {
                    ui.add_space(16.0);
                    if ui.button(RichText::new("+ Import .conf")
                        .font(FontId::proportional(12.0))
                        ...
                        .clicked()
                    {
                            ...
                            .pick_file()
                        {
                            ...
                            self.import_name = path.file_stem()
                                .unwrap_or_default()
                                .to_string_lossy()
                                .to_string();
                    ...
                    if self.selected.is_some() {
                        ui.with_layout(egui::Layout::right_to_left(egui::Align::Center), |ui| {
                            ui.add_space(16.0);
                            if ui.button(RichText::new("Delete")
                                .font(FontId::proportional(12.0))
                ...
                if self.show_import {
                    ...
                    egui::Frame::none()
                        ...
                        .show(ui, |ui| {
                            ui.label(RichText::new("Path to .conf file:")
                                .font(FontId::proportional(11.0))
                                .color(Color32::from_rgb(120, 120, 140)));
